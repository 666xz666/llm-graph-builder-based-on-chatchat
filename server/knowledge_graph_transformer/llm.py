...
class LLMGraphTransformer:
    ...
    def process_response(self, document: Document) -> GraphDocument:
        ...
        ###
        print("The raw schema of the response is: ")
        print(raw_schema)
...
if __name__=='__main__':
    ...
    import os
    os.environ["QIANFAN_AK"] = "FNNwfaQBIWOtZvR0wPJmENZs"
    os.environ["QIANFAN_SK"] = "hTMVLkcraQAiP3A4aZE1H0BVn2Iu1ENt"
    ...
    transformer = LLMGraphTransformer(
        llm=llm,
        allowed_nodes=["Person", "Organization"],
        allowed_relationships=["CEO", "FOUNDED"],
    )
    
    # 创建文档实例
    documents = [
        Document(page_content="马斯克是SpaceX和Tesla的CEO。"),
        Document(page_content="苹果公司由史蒂夫·乔布斯、史蒂夫·沃兹尼亚克和罗纳德·韦恩创立。"),
        Document(page_content="马克·扎克伯格是Facebook的联合创始人兼CEO。"),
        Document(page_content="微软公司是一家由比尔·盖茨和保罗·艾伦创立的美国跨国科技公司。"),
        Document(page_content="马云是阿里巴巴集团的创始人，他于1999年创立了这家公司。"),
        Document(page_content="李彦宏是中国搜索引擎公司百度的联合创始人、董事长兼CEO。"),
        Document(page_content="任正非是华为技术有限公司的创始人兼首席执行官。"),
        Document(page_content="京东是中国的一家大型电子商务公司，由刘强东于1998年创立。"),
        Document(page_content="腾讯是一家总部位于中国的跨国技术公司，由马化腾于1998年创立。"),
        Document(page_content="华为是全球领先的信息与通信技术（ICT）解决方案提供商，总部位于中国深圳。")
    ]
